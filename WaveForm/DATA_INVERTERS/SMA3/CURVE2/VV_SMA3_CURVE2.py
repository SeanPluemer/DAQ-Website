...
CURVE2_volts = np.array([213,220.8,232.8,247.2,259.2,264])
CURVE2_vars = np.array([800,800,0,0,-800,-800])

#ploting
size_marker=10
plt.plot(CURVE2_volts/240,CURVE2_vars/1600,color='black',linewidth=4.0,label='Programmed function 3')
