...
import connect_to_daq, run_a_in
import pandas as pd
#first step is to read the test parameters and signal configs

def read_test_params():
    signal_csv_data = pd.read_csv("/home/pi/DAQ_Tests/files_from_server/signal_config.csv",index_col=False)    #print(df)
    test_csv_data = pd.read_csv("/home/pi/DAQ_Tests/files_from_server/test_config.csv",index_col=False) 
...
def main():
    ...
    sampling_rate = test_csv_data.SamplingRate.item()
